...
public class StudentController {
	...
	public Long getStudentsNameQuantity(@RequestBody List<String> names) {
		return studentService.getStudentsNameQuantity(names);
	}

	@GetMapping("/students/exam/{exam}/minscore/{minScore}")
	List<StudentDto> findStudentsByExamMinScore(@PathVariable String exam, @PathVariable Integer minScore) {
